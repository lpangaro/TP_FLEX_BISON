...
static const char *const yytname[] =
{
  ...
  "ID", "CONSTANTE", "ASIGNACION", "PARENIZQUIERDO", "PARENDERECHO",
  "COMA", "PUNTOYCOMA", "MAS", "MENOS", "$accept", "sumar", 0
};
#endif
  ...
  switch (yyn)
    {
        case 3:
#line 20 "bison.y"
    {mostrarResultado((yyvsp[(1) - (3)].num)+(yyvsp[(3) - (3)].num));}
    break;
